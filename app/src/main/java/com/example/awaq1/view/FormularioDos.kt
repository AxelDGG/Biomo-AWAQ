    ...
    LaunchedEffect(formularioId) {
        if (formularioId != 0L) {
            val formulario = appContainer.formulariosRepository
                .getFormularioDosStream(formularioId).first()
            ...
            if (formulario != null) {
                ...
                Log.e("Formulario2Loading", "No se pudo obtener formulario2 id=$formularioId")
            }
        }
    }
                            ...
                            Button(
                                onClick = {
                                    ...
                                    if (currentUserId != null) {
                                        ...
                                        Log.e("Formulario2", "No se pudo enviar: userId nulo")
                                    }
                                },
                                colors = ButtonDefaults.buttonColors(
                                    containerColor = Color(0xFF4E7029),
